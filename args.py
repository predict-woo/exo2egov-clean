...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/cluster/work/cvg/students/andrye/exo2egov/outputs",
    ...
    parser.add_argument(
        ...
        type=str,
        default="egoexo4d",
        choices=["egoexo4d", "h2o"],
        help="Dataset type to use for training (egoexo4d or h2o)",
    )
    parser.add_argument(
        "--h2o_root",
        type=str,
        default="/cluster/project/cvg/data/H2O",
        help="Root directory for H2O dataset",
    )
