...
def main(cfg,args,conf):
    ...
    # Set MLflow tracking directory explicitly
    mlflow_tracking_dir = "/cluster/work/cvg/students/andrye/exo2egov/mlruns"
    ...
    accelerator = Accelerator(
        ...
        log_with="mlflow",
        project_dir=mlflow_tracking_dir,
    ...
    dataset_type = getattr(args, 'dataset_type', 'egoexo4d')
    if dataset_type == 'h2o':
        logger.info("Using H2O dataset")
        train_dataset = H2ODataset(args=args, sample_frames=args.num_frames)
    else:
        logger.info("Using EgoExo4D dataset")
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % args.validation_steps == 0:
                    ...
                    if accelerator.is_main_process:
                        ...
                        for sample_id, sample_dict in enumerate(sample_dicts):
                            sample_name: Any = sample_dict["name"]
                            img = sample_dict["img"]
                            # # print(img.shape)
                            # print(img)
